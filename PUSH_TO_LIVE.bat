...
:: Ensure Git Credential Manager and MinGit binaries are in PATH if present
if exist "%LOCALAPPDATA%\MinGit\cmd\git.exe" (
    set "PATH=%LOCALAPPDATA%\MinGit\mingw64\bin;%LOCALAPPDATA%\MinGit\cmd;%PATH%"
)

echo =========================================================================
echo    Sumerpur Municipal Election 2026 - Deploy Results to Live Portal
echo =========================================================================
echo.
echo 1. Live Matdan Data Status: 21,325 votes across 35 booths PROTECTED & SAVED.
echo 2. Results Module: Official 14-09-2026 results restored (35 wards, 21325 votes).
...
git push https://%GH_TOKEN%@github.com/Mahendrac2/election-sumerpur-2026.git main
