...
function enterPublicGuestMode() {
    ...
    if (['reports', 'archive', 'livedisplay', 'dashboard', 'booths', 'zones'].includes(currentHash)) {
        renderCurrentView();
    } else {
        navigateTo('dashboard');
    }
...
function handleHashNavigation() {
    ...
    // Direct redirect to dedicated Counting & Results Portal
    if (hash === 'results') {
...
// =============================================================================
// भाग 2: 14-09-2026 मतगणना एवं परिणाम (Dedicated at /results)
// =============================================================================
function openCountingEntryModal() {
    window.location.href = '/results';
}
function openForm21Certificate() {
    window.location.href = '/results';
}
